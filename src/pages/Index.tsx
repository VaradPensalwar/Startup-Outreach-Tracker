...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-muted/80 py-8 px-4 print:bg-white print:py-0 space-y-8 print:space-y-0">
      {pages.map((pageCompanies, pageIndex) => (
        <div key={pageIndex} className="mx-auto bg-card shadow-[0_2px_20px_rgba(0,0,0,0.08)] border border-border print:shadow-none print:border-0 print:break-after-page"
          ...
          <div className="border border-border rounded overflow-hidden">
            <div className="grid grid-cols-[auto_1fr_auto_auto] items-center gap-4 px-4 py-2 bg-muted/50 border-b border-border text-xs font-display font-medium text-muted-foreground uppercase tracking-wider">
              <span className="w-4" />
              <span>Company</span>
              <span>Priority</span>
              <span>Status</span>
